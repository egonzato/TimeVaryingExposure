...
\
```{r, echo=FALSE, message=FALSE,warning=FALSE, out.height="35%",fig.align="center"}
library(pacman)
p_load(mtvc,dplyr,readxl,tidyverse)
knitr::include_graphics("G:\\Il mio Drive\\journal\\FINALE\\Time Varying Exposure\\tve.png")
```
...
# load dataset
df=read_xlsx("G:\\Il mio Drive\\journal\\FINALE\\Time Varying Exposure\\intermittence.xlsx")
```
\
